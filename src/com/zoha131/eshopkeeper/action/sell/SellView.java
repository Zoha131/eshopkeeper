...
import com.zoha131.eshopkeeper.dialog.AddProductDialog;
import com.zoha131.eshopkeeper.home.Main;
import com.zoha131.eshopkeeper.dialog.Toast;
...
import com.zoha131.eshopkeeper.print.InvoiceSell;
...
public class SellView {
        ...
        try {
            ...
            if (job != null ) {
                ...
                for(int i=1;i<=pages;i++){
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/zoha131/eshopkeeper/print/invoiceSell.fxml"));
                    node = loader.load();
    ...
    //todo-me com.zoha131.eshopkeeper.add a logic so that a product can't be added twice in the invoice
