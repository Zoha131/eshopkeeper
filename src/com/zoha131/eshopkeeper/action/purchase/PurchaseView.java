package com.zoha131.eshopkeeper.action.purchase;
...
public class PurchaseView {
    ...
    private void  addConsumer(AddProductDialog.DialogModel dialogModel){
        //get product by name and com.zoha131.eshopkeeper.add to the invoice data
    ...
    private void setTableColumn(){
        ...
        rateColumn.setOnEditCommit(event -> {
            ...
            itemTable.refresh();
            itemTable.requestFocus();
            //todo-me Tab->next com.zoha131.eshopkeeper.edit cell Enter->commit com.zoha131.eshopkeeper.edit
        });
